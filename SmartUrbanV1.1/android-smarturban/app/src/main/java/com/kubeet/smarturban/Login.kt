...
import com.kubeet.models.Cars_Document
import com.kubeet.models.Employes_Document
import com.kubeet.models.sessionStorage
import com.kubeet.smarturban.ViewDialog
import com.kubeet.smarturban.other.DataTracks
import com.kubeet.smarturban.other.DatabaseHandler
...
class   Login : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        super.onCreate(savedInstanceState)
            ...
            setContentView(R.layout.plantilla_login1)
            viewDialog = ViewDialog(this)
            auth = FirebaseAuth.getInstance()

            email = findViewById<EditText>(R.id.idUser) as EditText
            password = findViewById<EditText>(R.id.idPass) as EditText
        ...
        calendarDay()
            ...
            println("error Permison Location")
        }
    ...
    fun btnLog(view: View){
        ...
        {
            val edtUserdInputLayout = this.findViewById<TextInputLayout>(R.id.input_user)
        ...
        {
            val edtPassworddInputLayout = this.findViewById<TextInputLayout>(R.id.input_pass)
                    ...
                    db.collection("cars")
                            ...
                            .addOnSuccessListener { result ->
                                for (document in result) {
                                    println("callCars ${document.id} => ${document.data}")
                                    val callCar = document.toObject(Cars_Document::class.java)

                                    if(email!!.text.toString() == callCar.unitid && password!!.text.toString() == callCar.unitid) {

                                        println("printId ${callCar.driverid}")

                                        sessionStorage.key = callCar.driverid
                                        sessionStorage.carId = callCar.unitid
                                        sessionStorage.userId = callCar.userid
