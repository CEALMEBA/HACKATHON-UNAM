...
import { RoutesDetailsService } from './services/route-details.service';
...
@NgModule({
	...
	providers: [AuthService, AuthGuard, AdminGaurd,
		...
		MarketingService, ProviderService, UserService, BusesService, FormBuilder, RoutesService, RoutesDetailsService]
})
